...
//Примеры:
//
//        📱 Корзина создана 10 дней назад, но юзер вчера что-то добавил → НЕ УДАЛЯЕТСЯ
//📱 Корзина создана 2 дня назад, но юзер 8 дней не заходил → УДАЛЯЕТСЯ
//📱 Пустая корзина любого возраста → УДАЛЯЕТСЯ СРАЗУ
//
//Система смотрит на последнюю активность, а не на дату создания! ⏰