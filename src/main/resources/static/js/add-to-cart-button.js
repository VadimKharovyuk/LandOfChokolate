...
//      */
//     static initAll(selector = '.add-to-cart, .btn-add-to-cart, [data-add-to-cart]') {
...
//                 if (node.matches && node.matches('.add-to-cart, .btn-add-to-cart, [data-add-to-cart]')) {
//                     AddToCartButton.init(node);
//                 }
//
//                 // Проверить дочерние элементы
//                 const buttons = node.querySelectorAll && node.querySelectorAll('.add-to-cart, .btn-add-to-cart, [data-add-to-cart]');
//                 if (buttons) {
